export default function BrandedDevelopments() {
  return (
    <section className="bg-[#F3F8FB] px-6  py-16 md:mx-20 rounded-xl">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        {/* Text Content */}
        <div className="max-w-2xl">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0A2C5C] leading-tight mb-6">
            Provident's Top Branded <br /> Developments in the UAE Coffee <br />{" "}
            Table Book
          </h2>
          <p className="text-gray-700 text-lg mb-6">
            The first-ever dedicated platform for branded developments in the
            UAE. Discover an exclusive collection of the finest properties in
            Provident's branded projects coffee table book.
          </p>
