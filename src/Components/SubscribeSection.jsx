  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://realestatebackend-uhf9.onrender.com/api/Subscribe",
        {
          method: "POST",
          headers: {
    ...
    <section className="bg-[#f6fafd]   px-3 py-12">
      <div className="max-w-7xl mx-auto  flex flex-col   md:flex-row items-center justify-between gap-6">
        ...
        <form
          ...
          className="flex flex-col sm:flex-row   lg:justify-end items-center gap-4 w-full md:max-w-2xl"
        >
          <input
            type="text"
            name="name"
          ...
          <button
            ...
            className={`flex-shrink-0 px-6 py-3 bg-gradient-to-r ${
              !isAgreed ? "bg-gray-500   " : "from-orange-500 to-orange-600  "
            } text-white font-semibold rounded-md shadow hover:opacity-90 transition`}
          >
